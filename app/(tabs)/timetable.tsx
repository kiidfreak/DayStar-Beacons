...
export default function TimetableScreen() {
  ...
  console.log('TimetableScreen: Component rendered');
  ...
  console.log('TimetableScreen: Rendering with user:', user?.id);
  ...
  useEffect(() => {
    console.log('TimetableScreen: useEffect triggered with user:', user?.id);
    if (user) {
      console.log('TimetableScreen: Fetching timetable data for user:', user.id);
      fetchTimetableData();
    }
  }, [user]);
